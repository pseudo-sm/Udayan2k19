...
def feed(request):
    ...
    #     images_temp2.append(storage.child("feed").child("Day 2").child(item).get_url(user["idToken"]))
    #     item_titles2.append(all_feed["Day 1"][item]["title"])
    #     item_desc2.append(all_feed["Day 1"][item]["description"])
    # for item in all_feed["Day 3"]:
    #     images_temp3.append(storage.child("feed").child("Day 3").child(item).get_url(user["idToken"]))
...
def technical(request):
    ...
    images = ['../static/Assets/Images/Committee/bhola.png','../static/Assets/Images/Committee/aaa.png','../static/Assets/Images/Committee/Arpan Kumar Samantaray.jpg','../static/Assets/Images/Committee/Pratik Dasmahapatra.jpg','../static/Assets/Images/Committee/SUBHANKAR 4-3.jpg','../static/Assets/Images/Committee/as.jpg','../static/Assets/Images/Committee/aish.jpg','../static/Assets/Images/Committee/IMG_20190108_123234.jpg','../static/Assets/Images/Committee/Saroj.jpg','../static/Assets/Images/Committee/Sripati.jpg']
